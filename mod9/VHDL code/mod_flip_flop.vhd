library ieee; use ieee.std_logic_1164.all;
	...
	remainder: out std_logic_vector(5 downto 0)); end mod_flip_flop;
...
architecture dataflow of mod_flip_flop is 
	...
	component mod9 is 
        ...
        signal remainder_ff,remainder_vec: std_logic_vector(5 downto 0);
begin
    --first flip flop
    ...
    --carry select adder
    adder: mod9 generic map(n) port map(a_ff, b_ff, remainder_vec);
   
    --second flip flop
    rem_qd: qd generic map (6) port map(remainder_vec, clk, rst, remainder_ff);
